...
public:
		...
		: Layer("Example"), _cameraController(1280.0f / 720.0f, true)
	{
		...
		std::dynamic_pointer_cast<Hazel::OpenGLShader>(textureShader)->UploadUniformFloat2("u_TilingFactor", glm::vec2(1.0f));
		std::dynamic_pointer_cast<Hazel::OpenGLShader>(textureShader)->UploadUniformFloat4("u_Color", glm::vec4(1.0f));
